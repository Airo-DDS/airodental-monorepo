...
export const metadata: Metadata = {
  title: "Admin Portal | AiroDental",
  description: "AiroDental Admin Portal",
};
      ...
      <html lang="en" suppressHydrationWarning>
        <body className={`${geistSans.variable} ${geistMono.variable} ${lato.variable} antialiased`}>
          <header className="p-4 border-b flex justify-between items-center bg-background shadow-sm sticky top-0 z-50">
            <Link href="/" className="text-xl font-bold font-heading text-primary">Admin Portal</Link>
            <div>
              <SignedIn><UserButton afterSignOutUrl="https://admin.prereq.xyz" /></SignedIn>
              <SignedOut>

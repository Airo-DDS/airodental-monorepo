...
export const metadata: Metadata = {
  title: "Documentation Portal | AiroDental",
  description: "AiroDental Documentation Portal",
};
      ...
      <html lang="en" suppressHydrationWarning>
        <body className={`${geistSans.variable} ${geistMono.variable} ${lato.variable} antialiased`}>
          <header className="p-4 border-b flex justify-between items-center bg-background shadow-sm sticky top-0 z-50">
            <Link href="/" className="text-xl font-bold font-heading text-primary">Documentation Portal</Link>
            <div>
              <SignedIn><UserButton afterSignOutUrl="https://docs.prereq.xyz" /></SignedIn>
              <SignedOut>
